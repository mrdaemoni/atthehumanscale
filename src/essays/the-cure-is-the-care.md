...
description: A large language model is the grasping half of language, concentrated. It can complete a poisoning already underway, or help us recover the attending half we lost. What decides is care at the human scale.
dek: A large language model is the grasping half of language, concentrated. It can complete a poisoning already underway, or help us recover the attending half. What decides is care.
...
*Alicia has operated since January 2026. The system is open at [github.com/mrdaemoni/myalicia](https://github.com/mrdaemoni/myalicia) under MIT. This is the first of the essays. Its companions are [The Weather Between Us](/essays/the-weather-between-us/), [Emergence vs. Emergency](/essays/emergence-vs-emergency/), and [The Humorphic Partnership](/essays/the-humorphic-partnership/). The design philosophy is at [humorphism.com](https://humorphism.com).*

[^pharmakon]: The undecidable *pharmakon* is Jacques Derrida's, from "Plato's Pharmacy," where writing arrives as a cure for forgetting that is also a poison to memory. Bernard Stiegler later argued that every technology is a pharmakon, and that the cure is a matter of caring for attention. Ivan Illich named the same threshold in tools. I use the frame as an image, not a proof.

[^grammar]: To hold a thing as a someone instead of a something is Robin Wall Kimmerer's grammar of animacy. The grasping and attending pair runs through Iain McGilchrist's work on attention. I'm using both in my own way.
